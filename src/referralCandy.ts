...
const initReferralCandy = () => {
  ...
  const initReferralCandyCode = () => {
    ...
    setTimeout(() => {
      const wrapperDivForScript = document.createElement("div");
      wrapperDivForScript.innerHTML = generatedScript;
      document.body.appendChild(wrapperDivForScript);
    }, 200);
  };
