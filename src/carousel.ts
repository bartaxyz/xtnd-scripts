class Carousel {
  ...
  initEventListeners() {
    [].forEach.call(this.controlsHandles, (handle: HTMLElement, index) => {
  ...
  updateActiveControlHandle() {
    if (typeof this.currentIndex !== "undefined") {
      (this.controlsHandleTimers[
        this.currentIndex
      ] as HTMLDivElement).style.width = `${(100 / this.timerDuration) *
        this.timer}%`;
    }
  }
...
addEventListener("DOMContentLoaded", () => {
  ...
  [].forEach.call(arrowRightWhiteElements, element => {
